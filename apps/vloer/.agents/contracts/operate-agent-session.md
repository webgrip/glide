...
- Preserve the session budget across interventions. For shared sessions follow [Ploeg execution](../../docs/contracts/ploeg-execution.md) and [recovery](../../../../docs/workflows/managed-execution.md#recovery); standalone retry and settlement rules do not apply to them.
