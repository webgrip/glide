...
| Repository-valid links broke in the built site | Add a [TechDocs hook](https://forgejo.webgrip.dev/webgrip/glide/src/commit/69d1af231a73b1a7532e9930ea2008b8b69baed2/apps/vloer/scripts/techdocs.py) that resolves existing repository-source targets to Forgejo while retaining Markdown and source examples unchanged |
| The default site navigation and search mixed current guides with historical material | Add deliberate [navigation](https://forgejo.webgrip.dev/webgrip/glide/src/commit/69d1af231a73b1a7532e9930ea2008b8b69baed2/apps/vloer/mkdocs.yml); keep evidence pages accessible while omitting research, ADRs, design baselines and the retired implementation guide from the local search index |
