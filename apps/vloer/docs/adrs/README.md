...
| [0012 — Every session is an Agent Host Protocol host](0012-agent-host-protocol-host.md) | Accepted for 0.3.0; 1.138 handshake verified, single-minor negotiation recorded as a defect |
