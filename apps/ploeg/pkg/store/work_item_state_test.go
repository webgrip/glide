...
func TestWorkItemStatesAreConstrainedToTheLifecycle(t *testing.T) {
	...
	id, _ := ingestItem(t)
	for _, state := range []work.State{work.StateIngested, work.StateQueued, work.StateLeased, work.StateNeedsHuman, work.StateAwaitingReview, work.StateStale, work.StateDone} {
