...
Markdown is the human and agent-readable prose. Render it as TechDocs or the [interactive landscape](landscape/explorer.html) when that helps a person read it. Use schemas and structured models for data that software validates. Keep [llms.txt](../apps/vloer/llms.txt) a small discovery index; it is not an alternative specification or a correctness guarantee.
