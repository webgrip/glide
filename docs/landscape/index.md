...
- **CTO and platform engineers:** read the current container, component, and deployment views in the [C4 views](c4.md), then the [implementation evidence](../../apps/vloer/docs/research/2026-09-11-ecosystem-implementation.md).
- **Build versus adopt:** read the [alternatives and their evidence](../../apps/vloer/docs/research/2026-09-11-ecosystem-alternatives.md). A product mentioned in a survey has not necessarily been tested.
...
A separate ticket import in that inspection failed on an OpenCode permission-list response. It stopped execution and blocked the model key. The [dated implementation evidence](../../apps/vloer/docs/research/2026-09-11-ecosystem-implementation.md) records the defect; consult current code and qualification results before treating it as still open.
