...
The [release publication workflow](../../.forgejo/workflows/on_release_published.yml) owns both applications' configured destinations. The table records the current intended set; recheck it when that workflow changes.
