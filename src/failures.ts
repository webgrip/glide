export type FailureCategory = 'missing_executable' | 'workspace_setup' | 'gateway_rejected' | 'budget_exhausted' | 'policy_violation' | 'harness_rejected' | 'connectivity' | 'timeout' | 'cancelled' | 'prompt_acceptance_unknown' | 'runtime_failure' | 'review_incomplete' | 'input_unresolved';
