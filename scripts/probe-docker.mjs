...
const config = {
  ...
  docker: { image, cpus: 1, memoryMb: 1024, pidsLimit: 256, gatewayUrl: `http://host.docker.internal:${sink.address().port}/v1`, provisionTimeoutMs: 120000 },
...
try {
  ...
  assert.equal(inspect.HostConfig.PortBindings['4096/tcp'][0].HostIp, '127.0.0.1');
